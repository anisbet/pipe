...
`bash-3.2$ head holds_1411.lst | pipe.pl -W"\^" -o`“`c3,c4,c6,c7`”` -m`“`c3:_____###,c4:__#,c6:__#,c7:__##_##_####`”` -s`“`c2`”` -T`“`HTML`”
	...
	ew feature in -m to allow arbitrary characters to be inserted. For data like this:
...
`                 Example data: `
  ...
  [randomselection.pl]: randomselection.pl "wikilink"
  [dedup.pl]: dedup.pl "wikilink"
  []: halfskull.png "halfskull.png"
  [1]: noskull.png "noskull.png"