...
usage()
{
    cat << EOFU!
 Usage: $0 [flags]
Test file for pipe.pl parameter P.
...
USE_CASE="Testing trailing pipe added to end of each line."
PARAMETERS="-P"
...
USE_CASE="Testing ensures trailing pipe but doesn't double-up pipe."
PARAMETERS="-P"
INPUT_FILE=${DATA_FILE_PREFIX}.txt
EXPECTED_OUT=${EXPECTED_STDOUT}.0.txt
EXPECTED_ERR=${EXPECTED_STDERR}.0.txt
...
USE_CASE="Test pipe-delimited columns separator with results of -d and -A."
PARAMETERS="-dc0 -A -P"
INPUT_FILE=${DATA_FILE_PREFIX}.txt
EXPECTED_OUT=${EXPECTED_STDOUT}.0.txt
EXPECTED_ERR=${EXPECTED_STDERR}.0.txt
